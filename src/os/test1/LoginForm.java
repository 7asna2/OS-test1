...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setFont(new java.awt.Font("Yu Mincho Demibold", 1, 14)); // NOI18N

        jTF2.setBackground(new java.awt.Color(255, 204, 255));
        ...
        lgn_btn.setBackground(new java.awt.Color(255, 153, 153));
        lgn_btn.setText("Log in");
        ...
        jPF.setBackground(new java.awt.Color(255, 204, 255));
        ...
        jLabel1.setText("Enter passwords & usernames' files :");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(100, 100, 100)
                        .addComponent(jPF, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(99, 99, 99)
                        .addComponent(jTF2, javax.swing.GroupLayout.PREFERRED_SIZE, 273, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void lgn_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_lgn_btnActionPerformed
        try {
            ...
            while(s.hasNext())
            if(s.next().trim().equals(jTF2.getText().trim())&& s.next().trim().equals(jPF.getText().trim())){
              // info INFO = new info();
